...
export default function ModalCard({ onClose, dataProject }) {
    const options = { delay: 3000 }; // Options
    const autoplayRoot = (emblaRoot) => emblaRoot.parentElement; // Root node
    const autoplay = Autoplay(options, autoplayRoot);

    const [emblaRef] = useEmblaCarousel({ loop: false, slidesToScroll: 1 }, [
        autoplay,
    ]);
                ...
                <div className="relative bg-white rounded-lg shadow">
                    ...
                    <div className="p-6 space-y-6 font-poppins md:space-y-4 md:p-8 xl:max-w-6xl">
                        ...
                        <div className="">
                            ...
                            <a
                                href={dataProject.code}
                                target="_blank"
                                rel="noreferrer"
                                className="md:flex md:justify-end"
                            >
                                <PrimaryBtn className="w-full my-8 md:text-base md:w-auto md:mt-10 md:mb-8">
                                    Lihat Source Code
                                </PrimaryBtn>
                            </a>
                        </div>
